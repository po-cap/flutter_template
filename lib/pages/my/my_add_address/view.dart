...
class MyAddAddressPage extends GetView<MyAddAddressController> {
  const MyAddAddressPage({super.key});
  ...
  Widget _buildTabBarItem(
    ...
    return ButtonWidget.outline(
      ...
      textColor: controller.tabIndex == index
          ? context.colors.scheme.onTertiary
  ...
  Widget _buildTabBar(BuildContext context) {
    return GetBuilder<MyAddAddressController>(
      tag: tag,
      id: "profile_tab",
      builder: (_) {
        return <Widget>[
